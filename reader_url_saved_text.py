...
def reader_url_saved_text_nomer(nomer_detali):
    """
    ...
    try:
        ...
        response = requests.get('https://voltag.ru/catalog/list/', params=params, cookies=cookies, headers=headers)
    except Exception:
...
def reader_url_saved_text_url(url):
    """
